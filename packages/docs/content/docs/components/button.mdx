...
<Playground
  ...
  code={`
<Row flexWrap="false">
    <Button shadow auto>Primary</Button>
    <Spacer />
    <Button shadow auto color="secondary">Secondary</Button>
    <Spacer />
    <Button shadow auto color="success">Success</Button>
    <Spacer />
    <Button shadow auto color="warning">Warning</Button>
    <Spacer />
    <Button shadow auto color="error">Error</Button>
    <Spacer />
    <Button shadow auto color="gradient">Gradient</Button>
    <Spacer />
...
<Playground
 ...
 <Spacer/>
 <Row flexWrap>
    <Button auto ghost color="#ff4ecd">
        #ff4ecd
    </Button>
 </Row>
 </>
...
<Playground
 ...
 <Row flexWrap="false">
    ...
    <Spacer/>
    <Button auto light color="#ff4ecd">
        #ff4ecd
    </Button>
 </Row>
`}
