...
<Grid.Container gap={2}>
  ...
  <Grid>
  <Button auto clickable={false} color="error" loaderType="gradient" css={{ px: '$13' }}>
    <Loading type="gradient" color="white" gradientBackground="#f21361" size="sm" />
  </Button>
  </Grid>
  <Grid>
  <Button auto clickable={false} color="gradient" css={{ px: '$13' }}>
    <Loading type="spinner" color="white" size="sm" />
  </Button>
  </Grid>
</Grid.Container>
...
| **ripple**       | `boolean`                                       | `true/false`                     | Display drip animation                    | `false`   |
