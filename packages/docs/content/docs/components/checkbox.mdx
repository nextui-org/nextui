...
| **textColor**      | `NormalColors`        | [NormalColors](#normal-colors) | Change checkbox text color                                             | `default` |
...
| **textColor** | `NormalColors`               | [NormalColors](#normal-colors) | Change checkbox group text color    | `default` |
