...
| ------------------ | --------------------- | ------------------------------ | ---------------------------------------------------------------------- | --------- |
| **color**          | `NormalColors`        | [NormalColors](#normal-colors) | Change checkbox color                                                  | `primary` |
| **textColor**      | `NormalColors`        | [SimpleColors](#simple-colors) | Change checkbox text color                                             | `default` |
...
| **textColor** | `NormalColors`               | [SimpleColors](#simple-colors) | Change checkbox group text color    | `default` |
...
| ...           | `HTMLAttributes`             | `'id', 'className', ...`       | Native checkbox props               | -         |
