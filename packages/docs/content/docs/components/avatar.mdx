...
<Playground
  ...
  <Grid.Container gap={2}>
    ...
    <Grid>
        <Avatar text="#ff4ecd" css={{ '.nextui-avatar-bg': { bg: '#ff4ecd' } }}/>
    </Grid>
 </Grid.Container>
`}
/>
...
<Playground
  ...
  <Grid.Container gap={2}>
    ...
    <Grid>
        <Avatar size="lg" src="/avatars/avatar-8.png" css={{ '.nextui-avatar-bg': { bg: '#ff4ecd' } }} bordered />
    </Grid>
 </Grid.Container>
`}
/>
...
<Playground
  ...
  <Grid.Container gap={2}>
    ...
    <Grid>
        <Avatar size="lg" src="/avatars/avatar-8.png" css={{ '.nextui-avatar-bg': { bg: '#ff4ecd' } }} bordered squared />
    </Grid>
 </Grid.Container>
`}
/>
