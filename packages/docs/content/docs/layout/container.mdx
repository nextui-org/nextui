...
```tsx
const breakpoints = {
  xs: '650px',  // Extra small devices (phones)
  sm: '960px',  // Small devices (tablets)
  md: '1280px', // Medium devices (landscape tablets)
  lg: '1400px', // Large devices (desktops)
  xl: '1920px'  // Extra large devices (larger desktops)
};
```
