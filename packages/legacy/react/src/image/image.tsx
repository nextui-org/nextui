...
export const Image = React.forwardRef((props: ImageProps, ref: ReactRef<HTMLImageElement>) => {
  const {
    src,
    width,
    height,
...
export default React.memo(Image) as MemoImageComponent<HTMLImageElement, ImageProps>;
