...
const expectCheckboxToHaveARIAChecked = (wrapper: ReactWrapper, value: boolean) => {
...
describe("Checkbox", () => {
  ...
  it("should change value after click", () => {
    ...
    expect(wrapper.find(".nextui-checkbox-text").at(0).text()).toContain("state2");
    expect(() => wrapper.unmount()).not.toThrow();
  });
  ...
  it("should ignore events when disabled", () => {
    ...
    userEvent.click(input.getDOMNode());
    expect(wrapper.find(".nextui-checkbox-text").at(0).text()).toContain("state1");
    expectCheckboxIsChecked(wrapper, false);
  ...
  it("should work correctly with line-through value", () => {
    ...
    expect((icon as HTMLInputElement).className).not.toContain("lineThrough-true");
