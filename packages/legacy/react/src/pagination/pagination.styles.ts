...
export type PaginationItemVariantsProps = VariantProps<typeof StyledPaginationItem>;
export type PaginationHighlightVariantsProps = VariantProps<typeof StyledPaginationHighlight>;
