...
describe("Input", () => {
  ...
  it("should ignore event when input disabled", () => {
    ...
    const wrapper = mount(<Input disabled onChange={callback} />);
  ...
  it("should ignore event when input readonly", () => {
    const callback = jest.fn();
    const wrapper = mount(<Input readOnly onChange={callback} />);
  ...
  it("should clear text", () => {
    ...
    const wrapper = mount(<Input clearable onChange={callback} onClearClick={clearHandler} />);
    ...
    wrapper.find(".nextui-input-clear-button").at(0).simulate("click", nativeEvent);
  ...
  it("should trigger focus correctly", () => {
    const focus = jest.fn();
    const blur = jest.fn();
    const wrapper = mount(<Input onBlur={blur} onFocus={focus} />);
