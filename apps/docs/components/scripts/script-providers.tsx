...
export function ScriptProviders() {
  return (
    <>
      <Script
        defer
        data-modal-disclaimer="This is a custom LLM for NextUI with access to all developer docs (nextui.org/docs) and GitHub Issues and PRs (github.com/frontio-ai/heroui)."
