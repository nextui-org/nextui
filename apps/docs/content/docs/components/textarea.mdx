...
| classNames         | `Partial<Record<"base"｜ "label"｜ "inputWrapper"｜ "innerWrapper" ｜ "input" ｜ "description" ｜ "errorMessage", string>>` | Allows to set custom class names for the checkbox slots.                                                                                                                                                                                                | -         |
