...
url: https://v1.nextui.org/docs/components/switch
---

# Switch

The Switch component is used as an alternative for the [Checkbox](https://v1.nextui.org/docs/components/checkbox)
