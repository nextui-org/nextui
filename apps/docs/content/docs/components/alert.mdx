...
If `isClosable` is true, a close button appear on alert which can be used to close it.
...
| isClosable      | `boolean`                                                                    | Whether the close button should be displayed.                | `true`    |
