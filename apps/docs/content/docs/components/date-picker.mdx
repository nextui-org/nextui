...
<ComponentLinks component="datepicker" />
...
| classNames            | `Record<"base"｜ "label"｜ "inputWrapper"｜ "innerWrapper"｜ "input"｜ "helperWrapper"｜ "description"｜ "errorMessage", string>`                                     | Allows to set custom class names for the date-picker slots.                                                            | -         |

### DatePicker Events

| Attribute     | Type                                                                   | Description                                                                                                                         |
| ------------- | -----------------------------------------------------------------------| ----------------------------------------------------------------------------------------------------------------------------------- |
| onChange      | `((value: ZonedDateTime \| CalendarDate \| CalendarDateTime) => void)` | Handler that is called when the date-picker's value changes.                                                                         |
