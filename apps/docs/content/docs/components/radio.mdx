...
| <kbd>ArrowLeft</kbd>  | When focus is on an item, moves focus to the previous item. |
| <kbd>ArrowRight</kbd> | When focus is on an item, moves focus to the next item.     |
...
| **isRow**           | `boolean`                     | Change the radio group direction                                                                                                                                 | `false`    |
