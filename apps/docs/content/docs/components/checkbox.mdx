...
| classNames       | `Record<"base"｜ "wrapper"｜ "icon"｜ "label", string>`                     | Classname or List of classes to change the classNames of the element. if `className` is passed, it will be added to the base slot. | -         |
