...
- **ListboxSection**: The component that contains a group of litbox items.
- **ListboxItem**: The component that represents a litbox item.
...
`ListboxItem` has the following attributes on the `root` element:
