...
| ------------------------ | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| **children\***           | `ReactNode[]`                       | The content of the navbar. It's usually the brand, content, toggle and collapse.                                                                    | -        |
...
| **variant**              | [NavbarVariant](#navbar-variants)   | The navbar positions variantions                                                                                                                    | `static` |
