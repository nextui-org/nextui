...
url: https://v1.nextui.org/docs/components/navbar
---
...
| **variant**              | [NavbarVariants](#navbar-variants)  | The navbar positions variations.                                                                                                                   | `static` |
...
> **Note**: `fluid` means the navbar will fill the entire width of the screen. You can see the complete breakpoint list [here](https://v1.nextui.org/docs/theme/default-theme#breakpoints).
