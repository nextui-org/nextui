...
| **disableTriggerPressedAnimation** | `boolean`                                              | Whether the trigger should show a pressed animation when the menu is open.                               | `false` |
...
| **showFullDescription** | `boolean`                                           | Whether the item description should be truncated or not.         | `false`   |
| **css**                 | `Stitches.CSS`                                      | Override Default CSS style.                                      | -         |
