...
<Playground
  title="Bordered"
  overflow="auto"
  desc="You can change the full style to a bordered `Pagination` with the `bordered` property."
  code={`
...
| **as**           | `ElementType`            | `'Button', 'h1'`                 | Changes which tag component outputs                              | `Pagination` |
