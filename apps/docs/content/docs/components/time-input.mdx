...
| classNames              | `Partial<Record<"base"｜ "label"｜ "inputWrapper"｜ "innerWrapper" ｜ "segment" ｜ "helperWrapper" ｜ "input" ｜ "description" ｜ "errorMessage", string>>` | Allows to set custom class names for the time input slots.                                                                                                           | -         |
