...
import {numberFieldContent} from "@/content/components/number-input";
...
<PackageManagers
  ...
  commands={{
    cli: "npx nextui-cli@latest add number-input",
    npm: "npm install @nextui-org/number-input",
    yarn: "yarn add @nextui-org/number-input",
    pnpm: "pnpm add @nextui-org/number-input",
    bun: "bun add @nextui-org/number-input"
  }}
/>
