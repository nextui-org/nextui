...
| size                      | `xs` \| `sm` \| `md` \| `lg` \| `xl`                                        | The popover size. This change the `PopoverContent` font size.                                                                                                | `md`            |
| color                     | `default` \| `primary` \| `secondary` \| `success` \| `warning` \| `danger` | The popover color theme.                                                                                                                                     | `default`       |
| radius                    | `none` \| `base` \| `sm` \| `md` \| `lg` \| `xl` \| `full`                  | The popover border radius.                                                                                                                                   | `xl`            |
| shadow                    | `none` \| `xs` \| `sm` \| `md` \| `lg` \| `xl` \| `2xl` \| `inner`          | The popover shadow.                                                                                                                                          | `lg`            |
