...
| **as**           | `ElementType`     | `'Button', 'a'`          | Changes which tag component outputs                                                           | `Modal` |
...
| **css**          | `styleObject`     | `css.properties`      | Override Default CSS style                              | -              |
| **as**           | `ElementType`     | `'Button', 'a'`       | Changes which tag component outputs                     | `Modal.Header` |
| ...            | `HTMLAttributes` | `'id', 'className', ...` | Native props                                            | -              |
...
| **autoMargin** | `boolean`        | `true/false`             | Apply or not a margin to the base elements of the modal | `true`       |
| **css**          | `styleObject`     | `css.properties`         | Override Default CSS style                           | -            |
| **as**           | `ElementType`     | `'Button', 'a'`          | Changes which tag component outputs                  | `Modal.Body` |
| ...            | `HTMLAttributes` | `'id', 'className', ...` | Native props                                            | -            |
...
| **css**        | `styleObject`    | `css.properties`         | Override Default CSS style                              | -              |
| **as**         | `ElementType`    | `'Button', 'a'`          | Changes which tag component outputs                     | `Modal.Footer` |
| ...            | `HTMLAttributes` | `'id', 'className', ...` | Native props                                            | -              |
