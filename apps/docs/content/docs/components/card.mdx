...
| **css**          | `styleObject`                                | `css.properties`                 | Override Default CSS style                                                                                 | -         |
| **as**           | `ElementType`                                | `'Button', 'a'`                  | Changes which tag component outputs                                                                        | `Card`    |
...
| --------- | ---------------- | ------------------------ | --------------------------------------- | ------------- |
| **css**   | `styleObject`    | `css.properties`         | Override Default CSS style              | -             |
| **as**    | `ElementType`    | `'Button', 'a'`          | Changes which tag component outputs     | `Card.Header` |
| ...       | `HTMLAttributes` | `'id', 'className', ...` | Native props                            | -             |
...
| ...       | `HTMLAttributes` | `'id', 'className', ...` | Native props                            | -             |
| **css**   | `styleObject`    | `css.properties`         | Override Default CSS style              | -             |
| **as**    | `ElementType`    | `'Button', 'a'`          | Changes which tag component outputs     | `Card.Body`   |
...
| **css**   | `styleObject`    | `css.properties`         | Override Default CSS style           | -             |
| **as**    | `ElementType`    | `'Button', 'a'`          | Changes which tag component outputs  | `Card.Footer` |
| ...       | `HTMLAttributes` | `'id', 'className', ...` | Native props                         | -             |
...
| **css**          | `styleObject`       | `css.properties`               | Override Default CSS style                        | -             |
| **as**           | `ElementType`       | `'Button', 'a'`                | Changes which tag component outputs               | `Card.Image`  |
