...
<ComponentLinks component="range-calendar" />
...
<ImportTabs
  commands={{
    ...
    individual: 'import {RangeCalendar} from "@nextui-org/range-calendar";',
  }}
/>
...
<CodeDemo 
  title="Usage" 
  files={rangeCalendarContent.usage} 
/>
...
<CodeDemo 
  title="Disabled" 
  files={rangeCalendarContent.disabled} 
/>
...
<CodeDemo
  title="Read Only"
  files={rangeCalendarContent.readonly}
/>
...
<CodeDemo
  title="Controlled"
  files={rangeCalendarContent.controlled}
/>
...
<CodeDemo
  ...
  files={rangeCalendarContent.minDateValue}
/>
...
<CodeDemo
  ...
  files={rangeCalendarContent.maxDateValue}
/>
...
<CodeDemo
  ...
  files={rangeCalendarContent.unavailableDates}
/>
...
<CodeDemo
  title="Unavailable Dates"
  files={rangeCalendarContent.nonContiguousRanges}
/>
...
<CodeDemo
  ...
  files={rangeCalendarContent.controlledFocusedValue}
/>
...
<CodeDemo
  title="Invalid Date"
  files={rangeCalendarContent.invalidDate}
/>
...
<CodeDemo
  ...
  files={rangeCalendarContent.internationalCalendars}
/>
...
<CodeDemo 
  ...
  files={rangeCalendarContent.visibleMonths} 
/>
...
<CodeDemo 
  ...
  files={rangeCalendarContent.pageBehaviour} 
/>
...
<CodeDemo
  title="Presets"
  files={rangeCalendarContent.presets}
/>
