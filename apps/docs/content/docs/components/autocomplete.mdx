...
<CodeDemo title="Custom Selector Icon" highlightedLines="15" files={autocompleteContent.customSelectorIcon} />
...
<CodeDemo title="Without Scroll Shadow" highlightedLines="13-15" files={autocompleteContent.withoutScrollShadow} />
...
<CodeDemo title="With Error Message" highlightedLines="16-18" files={autocompleteContent.errorMessage} />
...
<CodeDemo title="Controlled with onSelectionChange" highlightedLines="15-16" files={autocompleteContent.controlled} />
...
<CodeDemo title="Fully Controlled" highlightedLines="22" files={autocompleteContent.customFiltering} />
