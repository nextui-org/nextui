...
<CodeDemo title="Start and End Content" files={dateRangePickerContent.startEndContent} />
...
<CodeDemo title="Custom Styles" highlightedLines="14-32" files={dateRangePickerContent.customStyles} />
...
<CodeDemo
  ...
  files={dateRangePickerContent.customImpl}
/>
