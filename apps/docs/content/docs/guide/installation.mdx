...
module.exports = {
  content: [
    // ...
    "./node_modules/@nextui-org/theme/dist/components/button.js", // <- single component styles
    // or you can use a glob pattern
    './node_modules/@nextui-org/theme/dist/components/(button|snippet|code|input).js' // <- multiple component styles
  ],
  theme: {
    extend: {},
  },
