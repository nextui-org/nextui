...
After installing NextUI, you need to set up the `HeroUIProvider` at the `root` of your application.
...
<Blockquote
 color="warning"
>
  Version 2 is only compatible with React 18 or later. If you are using React 17 or earlier, please use <Link href="https://v1.heroui.com/docs/getting-started" isExternal>version 1 of NextUI</Link>.
</Blockquote>
