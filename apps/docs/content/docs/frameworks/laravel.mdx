...
<PackageManagers
  commands={{
    npm: 'npx create-laravel@latest --template https://github.com/frontioai/laravel-template',
    yarn: 'yarn create laravel --template https://github.com/frontioai/laravel-template',
    pnpm: 'pnpm create laravel --template https://github.com/frontioai/laravel-template',
    bun: 'bunx create-laravel@latest --template https://github.com/frontioai/laravel-template',
  }}
/>
