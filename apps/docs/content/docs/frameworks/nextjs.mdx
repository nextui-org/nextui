...
<PackageManagers
  commands={{
    npm: 'npx create-next-app -e https://github.com/nextui-inc/next-app-template',
    yarn: 'yarn create next-app -e https://github.com/nextui-inc/next-app-template',
    pnpm: 'pnpm create next-app -e https://github.com/nextui-inc/next-app-template'
  }}
/>
